Ext.define('Base.gis.source.SourceGridPanel', {
	extend: 'Base.ux.GridPanel',

	initComponent: function() {
		Ext.apply(this, {
			itemId: 'sourceGridPanel',
			url: ctx + '/gis/source/dataset.ctrl',
			sortProperty: 'sort',
			sortDirection: 'asc',
			idProperty: 'id',
			columns: [{
	...
	doAddEvent: function() {
		Ext.create('Base.gis.source.SourceFormWindow', {opener: this}).show();
	},
	doEditEvent: function(id) {
		Ext.create('Base.gis.source.SourceFormWindow', {opener: this, entityId: id}).show();
	},
	doViewEvent: function(id) {
		Ext.create('Base.gis.source.SourceFormWindow', {opener: this, entityId: id, readOnlyForm: true}).show();
	},
	doDeleteEvent: function(ids) {
		Ext.Ajax.request({
			url: ctx + '/gis/source/delete.ctrl',
			params: {
				ids: ids
			},
