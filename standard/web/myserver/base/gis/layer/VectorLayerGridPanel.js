Ext.define('Base.gis.layer.VectorLayerGridPanel', {
	...
	initComponent: function() {
		...
		this.store.on('beforeload', function(store, operation, eOpts) {
			...
			Ext.apply(this.store.proxy.extraParams, {
				'qc.layerClassName': 'ol.layer.Vector',
	...
	doAddEvent: function() {
		Ext.create('Base.gis.layer.VectorLayerFormWindow', {opener: this}).show();
	},
	doEditEvent: function(id) {
		Ext.create('Base.gis.layer.VectorLayerFormWindow', {opener: this, entityId: id}).show();
	},
	doViewEvent: function(id) {
		Ext.create('Base.gis.layer.VectorLayerFormWindow', {opener: this, entityId: id, readOnlyForm: true}).show();
	},
